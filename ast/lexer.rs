...
impl<'src> Lexer<'src> {
    ...
    fn scan_word(&mut self) -> LexToken {
        ...
        match &self.src[start..self.pos] {
            ...
            "__FIRMION_VERSION_STRING" => LexToken::BuiltinVersionString,
            "__FIRMION_VERSION_MAJOR"  => LexToken::BuiltinVersionMajor,
            "__FIRMION_VERSION_MINOR"  => LexToken::BuiltinVersionMinor,
            "__FIRMION_VERSION_PATCH"  => LexToken::BuiltinVersionPatch,
            "include"                => LexToken::Include,
            "region"                 => LexToken::Region,
            "in"                     => LexToken::In,
            "section"                => LexToken::Section,
            "align"                  => LexToken::Align,
            "pad_sec_offset"         => LexToken::PadSecOffset,
            "pad_addr_offset"        => LexToken::PadAddrOffset,
            "pad_file_offset"        => LexToken::PadFileOffset,
            ...
            "wr56"                   => LexToken::Wr56,
            "wr64"                   => LexToken::Wr64,
            "wrbe8"                  => LexToken::Wrbe8,
            "wrbe16"                 => LexToken::Wrbe16,
            "wrbe24"                 => LexToken::Wrbe24,
            "wrbe32"                 => LexToken::Wrbe32,
            "wrbe40"                 => LexToken::Wrbe40,
            "wrbe48"                 => LexToken::Wrbe48,
            "wrbe56"                 => LexToken::Wrbe56,
            "wrbe64"                 => LexToken::Wrbe64,
            "wrf"                    => LexToken::Wrf,
            "wr"                     => LexToken::Wr,
            "obj"                    => LexToken::Obj,
